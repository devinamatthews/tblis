...
template <typename T>
void tblis_asumv_ref(thread_communicator& comm,
...
template <typename T>
void tblis_asumv(len_type n, const T* A, stride_type inc_A, T& sum)
{
    parallelize
    (
...
template <typename T>
T tblis_asumv(len_type n, const T* A, stride_type inc_A)
{
    T sum;
...
template void tblis_asumv_ref(thread_communicator& comm, idx_type n, const T* A, stride_type inc_A, T& sum); \
