...
template <typename T>
void tblis_sumv_ref(ThreadCommunicator& comm, idx_type n,
...
template void tblis_sumv_ref(ThreadCommunicator& comm, idx_type n, const T* A, stride_type inc_A, T& sum); \
