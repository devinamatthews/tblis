              ...
              const tblis_matrix& A, const tblis_matrix& B, tblis_matrix& C)
{
    ...
    TBLIS_WITH_TYPE_AS(A.type, T,
    {
        ...
        gemm.distribute = tc.jc_nt;
        gemm.child.child.child.distribute = tc.ic_nt;
        gemm.child.child.child.child.child.distribute = tc.jr_nt;
        gemm.child.child.child.child.child.child.distribute = tc.ir_nt;
