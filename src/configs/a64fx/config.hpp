#ifndef _TBLIS_CONFIGS_A64FX_CONFIG_HPP_
#define _TBLIS_CONFIGS_A64FX_CONFIG_HPP_
...
extern int a64fx_check();

TBLIS_BEGIN_CONFIG(a64fx)
    ...
    TBLIS_CONFIG_CHECK(a64fx_check)
