...
#define TBLIS_HAS_COMMA(...)                                    \
    TBLIS_HAS_COMMA_HELPER(__VA_ARGS__, 1, 1, 1, 1, 1, 0, barf)
#define TBLIS_COMMA_IF_EMPTY() , , , , ,
#define _TBLIS_COMMA_IF_EMPTY() , , , , ,
#define TBLIS_IS_EMPTY(x)                                   \
    TBLIS_HAS_COMMA(TBLIS_PASTE(x, TBLIS_COMMA_IF_EMPTY)())
...
#define TBLIS_CONFIG_REGISTER_BLOCKSIZE(name,                                 \
                                        S,                                    \
                                        D,                                    \
                                        C,                                    \
                                        Z,                                    \
...
#define TBLIS_CONFIG_CACHE_BLOCKSIZE(name,                                    \
                                     RB,                                      \
                                     S,                                       \
                                     D,                                       \
                                     C,                                       \
...
#define TBLIS_CONFIG_ADDF_NF(S, D, C, Z)     \
    TBLIS_CONFIG_REGISTER_BLOCKSIZE(addf_nf, \
                                    S,       \
                                    D,       \
                                    C,       \
                                    Z,       \
...
#define TBLIS_CONFIG_DOTF_NF(S, D, C, Z)     \
    TBLIS_CONFIG_REGISTER_BLOCKSIZE(dotf_nf, \
                                    S,       \
                                    D,       \
                                    C,       \
                                    Z,       \
...
#define TBLIS_CONFIG_TRANS_MR(S, D, C, Z)     \
    TBLIS_CONFIG_REGISTER_BLOCKSIZE(trans_mr, \
                                    S,        \
                                    D,        \
                                    C,        \
                                    Z,        \
...
#define TBLIS_CONFIG_TRANS_NR(S, D, C, Z)     \
    TBLIS_CONFIG_REGISTER_BLOCKSIZE(trans_nr, \
                                    S,        \
                                    D,        \
                                    C,        \
                                    Z,        \
...
#define TBLIS_CONFIG_GEMM_MR(S, D, C, Z)     \
    TBLIS_CONFIG_REGISTER_BLOCKSIZE(gemm_mr, \
                                    S,       \
                                    D,       \
                                    C,       \
                                    Z,       \
...
#define TBLIS_CONFIG_GEMM_NR(S, D, C, Z)     \
    TBLIS_CONFIG_REGISTER_BLOCKSIZE(gemm_nr, \
                                    S,       \
                                    D,       \
                                    C,       \
                                    Z,       \
...
#define TBLIS_CONFIG_GEMM_KR(S, D, C, Z)     \
    TBLIS_CONFIG_REGISTER_BLOCKSIZE(gemm_kr, \
                                    S,       \
                                    D,       \
                                    C,       \
                                    Z,       \
...
#define TBLIS_CONFIG_GEMM_MC(S, D, C, Z)  \
    TBLIS_CONFIG_CACHE_BLOCKSIZE(gemm_mc, \
                                 gemm_mr, \
                                 S,       \
                                 D,       \
                                 C,       \
...
#define TBLIS_CONFIG_GEMM_NC(S, D, C, Z)  \
    TBLIS_CONFIG_CACHE_BLOCKSIZE(gemm_nc, \
                                 gemm_nr, \
                                 S,       \
                                 D,       \
                                 C,       \
...
#define TBLIS_CONFIG_GEMM_KC(S, D, C, Z)  \
    TBLIS_CONFIG_CACHE_BLOCKSIZE(gemm_kc, \
                                 gemm_kr, \
                                 S,       \
                                 D,       \
                                 C,       \
...
#define TBLIS_CONFIG_GEMM_ROW_MAJOR(S, D, C, Z) \
    TBLIS_CONFIG_PARAMETER(gemm_row_major,      \
                           bool,                \
                           S,                   \
                           D,                   \
                           C,                   \
...
#define TBLIS_CONFIG_GEMM_FLIP_UKR(S, D, C, Z) \
    TBLIS_CONFIG_PARAMETER(gemm_flip_ukr,      \
                           bool,               \
                           S,                  \
                           D,                  \
                           C,                  \
...
#define TBLIS_CONFIG_GEMM_WRAP_UKR(S, D, C, Z)                               \
    ...
    : static_microkernel<                                                    \
          T,                                                                 \
          gemm_ukr_t,                                                        \
          TBLIS_GET_VALUE_IF(S,                                              \
                             (blis_wrap_gemm_ukr<this_config, float, S>),    \
                             (gemm_ukr_def<this_config, float>)),            \
          TBLIS_GET_VALUE_IF(D,                                              \
                             (blis_wrap_gemm_ukr<this_config, double, D>),   \
                             (gemm_ukr_def<this_config, double>)),           \
          TBLIS_GET_VALUE_IF(C,                                              \
                             (blis_wrap_gemm_ukr<this_config, scomplex, C>), \
                             (gemm_ukr_def<this_config, scomplex>)),         \
          TBLIS_GET_VALUE_IF(Z,                                              \
                             (blis_wrap_gemm_ukr<this_config, dcomplex, Z>), \
                             (gemm_ukr_def<this_config, dcomplex>))>         \
    {                                                                        \
    };

#define TBLIS_CONFIG_PACK_NN_MR_UKR(S, D, C, Z) \
    TBLIS_CONFIG_UKR3(this_config,              \
                      matrix_constants::MAT_A,  \
                      pack_nn_mr_ukr,           \
                      pack_nn_ukr_t,            \
                      S,                        \
                      D,                        \
...
template <typename T, typename U, U S, U D, U C, U Z> struct static_value
{
...
template <typename Config> struct config_template
{
    ...
    // template <typename T> struct pack_nb_mr_ukr : static_microkernel<T,
    // pack_nb_ukr_t, \
