...
template <typename T>
using bli_packm_t = void (*)(conj_t conja,
                             len_type n,
                             const T* kappa,
                             const T* a,
                             stride_type rs_a,
                     ...
                     double* p_ap)
{
    ...
    if (m == 30)
    {
        bli_dpackm_30xk_opt(BLIS_NO_CONJUGATE, k, &one, p_a, rs_a, cs_a, p_ap,
32);
    }
    else
    {
...
void knl_dpackm_24xk(len_type m,
                     len_type k,
                     const void* alpha,
                     bool conj,
                     const void* p_a,
                     ...
                     void* p_ap)
{
    if (m == 24 && !p_d && !p_e)
    {
        bli_dpackm_24xk_opt(conj ? BLIS_CONJUGATE : BLIS_NO_CONJUGATE,
                            ...
                            reinterpret_cast<const double*>(p_a),
                            rs_a,
                            cs_a,
                            reinterpret_cast<double*>(p_ap),
                            24);
    }
    else
    {
        pack_nn_ukr_def<knl_config, double, matrix_constants::MAT_A>(m,
                                                                     k,
                                                                     alpha,
                                                                     conj,
                                                                     p_a,
...
void knl_dpackm_8xk(len_type m,
                    len_type k,
                    const void* alpha,
                    bool conj,
                    const void* p_a,
                    ...
                    void* p_ap)
{
    ...
    {
        pack_nn_ukr_def<knl_config, double, matrix_constants::MAT_B>(m,
                                                                     k,
                                                                     alpha,
                                                                     conj,
                                                                     p_a,
...
void knl_spackm_24xk(len_type m,
                     len_type k,
                     const void* alpha,
                     bool conj,
                     const void* p_a,
                     ...
                     void* p_ap)
{
    if (m == 24)
    {
        bli_spackm_24xk_opt(conj ? BLIS_CONJUGATE : BLIS_NO_CONJUGATE,
                            ...
                            reinterpret_cast<const float*>(p_a),
                            rs_a,
                            cs_a,
                            reinterpret_cast<float*>(p_ap),
                            24);
    }
    else
    {
        pack_nn_ukr_def<knl_config, float, matrix_constants::MAT_A>(m,
                                                                    k,
                                                                    alpha,
                                                                    conj,
                                                                    p_a,
...
void knl_spackm_16xk(len_type m,
                     len_type k,
                     const void* alpha,
                     bool conj,
                     const void* p_a,
                     ...
                     void* p_ap)
{
    ...
    {
        pack_nn_ukr_def<knl_config, float, matrix_constants::MAT_B>(m,
                                                                    k,
                                                                    alpha,
                                                                    conj,
                                                                    p_a,
