...
int skx1_check()
{
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Wrong vendor.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Doesn't support AVX.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Doesn't support FMA3.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Doesn't support AVX2.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Doesn't support AVX512F.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Doesn't support AVX512DQ.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Doesn't support AVX512BW.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Doesn't support AVX512VL.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: skx1: Wrong number of VPUs (%d).\n", nvpu);
        return -1;
    }
