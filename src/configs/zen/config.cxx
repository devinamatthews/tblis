...
int zen_check()
{
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: zen: Doesn't support AVX.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: zen: Doesn't support FMA3.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: zen: Doesn't support AVX2.\n");
        return -1;
    }
    ...
    {
        if (get_verbose() >= 1)
            printf("tblis: zen: Wrong family (%xh).\n", family);
        return -1;
    }
