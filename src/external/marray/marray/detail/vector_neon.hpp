...
template <> struct vector_traits<float>
{
    ...
    template <typename T>
    static std::enable_if_t<std::is_same_v<T, uint8_t>, uint8x16_t>
    convert(float32x4_t v)
    {
    ...
    template <typename T>
    static std::enable_if_t<std::is_same_v<T, int16_t>, int16x8_t>
    convert(float32x4_t v)
    {
    ...
    template <typename T>
    static std::enable_if_t<std::is_same_v<T, uint16_t>, uint16x8_t>
    convert(float32x4_t v)
    {
    ...
    static float32x4_t load1(const float* ptr) { return vld1q_dup_f32(ptr); }

    static float32x4_t set1(float val) { return vdupq_n_f32(val); }
    ...
    {
        float32x4_t c;
        c = vsetq_lane_f32(std::pow(vgetq_lane_f32(a, 0), vgetq_lane_f32(b, 0)),
                           c,
                           0);
        c = vsetq_lane_f32(std::pow(vgetq_lane_f32(a, 1), vgetq_lane_f32(b, 1)),
                           c,
                           1);
        c = vsetq_lane_f32(std::pow(vgetq_lane_f32(a, 2), vgetq_lane_f32(b, 2)),
                           c,
                           2);
        c = vsetq_lane_f32(std::pow(vgetq_lane_f32(a, 3), vgetq_lane_f32(b, 3)),
                           c,
                           3);
        return c;
    }

    static float32x4_t negate(float32x4_t a) { return vnegq_f32(a); }
    ...
    static float32x4_t sqrt(float32x4_t a) { return vsqrtq_f32(a); }
};
...
template <> struct vector_traits<double>
{
    ...
    static float64x2_t set1(double val) { return vdupq_n_f64(val); }
    ...
    {
        float64x2_t c;
        c = vsetq_lane_f64(std::pow(vgetq_lane_f64(a, 0), vgetq_lane_f64(b, 0)),
                           c,
                           0);
        c = vsetq_lane_f64(std::pow(vgetq_lane_f64(a, 1), vgetq_lane_f64(b, 1)),
                           c,
                           1);
        return c;
    }

    static float64x2_t negate(float64x2_t a) { return vnegq_f64(a); }
    ...
    static float64x2_t sqrt(float64x2_t a) { return vsqrtq_f64(a); }
};
...
struct vector_traits<
    U,
    std::enable_if_t<std::is_same_v<U, int8_t> || std::is_same_v<U, uint8_t>>>
{
    static constexpr int vector_width = 16;
    static constexpr size_t alignment = 16;
    typedef std::conditional_t<std::is_signed_v<U>, int8x16_t, uint8x16_t>
        vector_type;
    ...
    static std::enable_if_t<
        ...
        std::conditional_t<std::is_signed_v<T>, int8x16_t, uint8x16_t>>
    convert(vector_type v)
    {
    ...
    static std::enable_if_t<
        ...
        std::conditional_t<std::is_signed_v<T>, int16x8_t, uint16x8_t>>
    convert(vector_type v)
    {
    ...
    static std::enable_if_t<
        ...
        std::conditional_t<std::is_signed_v<T>, int32x4_t, uint32x4_t>>
    convert(vector_type v)
    {
        if constexpr (std::is_signed_v<U>)
        {
    ...
    static std::enable_if_t<
        ...
        std::conditional_t<std::is_signed_v<T>, int64x2_t, uint64x2_t>>
    convert(vector_type v)
    {
        if constexpr (std::is_signed_v<U>)
        {
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 16, vector_type> load(const U* ptr)
    {
        if constexpr (std::is_signed_v<U>)
            return vld1q_s8(ptr);
        else
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 8, vector_type> load(const U* ptr)
    {
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 4, vector_type> load(const U* ptr)
    {
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 2, vector_type> load(const U* ptr)
    {
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 16> store(vector_type v, U* ptr)
    {
        if constexpr (std::is_signed_v<U>)
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 8> store(vector_type v, U* ptr)
    {
        if constexpr (std::is_signed_v<U>)
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 4> store(vector_type v, U* ptr)
    {
        if constexpr (std::is_signed_v<U>)
    ...
    template <int Width, bool Aligned>
    static std::enable_if_t<Width == 2> store(vector_type v, U* ptr)
    {
        if constexpr (std::is_signed_v<U>)
    ...
    static vector_type div(vector_type a, vector_type b)
    {
        if constexpr (std::is_signed_v<U>)
        {
            ...
            c = vsetq_lane_s8(vgetq_lane_s8(a, 10) / vgetq_lane_s8(b, 10),
                              c,
                              10);
            c = vsetq_lane_s8(vgetq_lane_s8(a, 11) / vgetq_lane_s8(b, 11),
                              c,
                              11);
            c = vsetq_lane_s8(vgetq_lane_s8(a, 12) / vgetq_lane_s8(b, 12),
                              c,
                              12);
            c = vsetq_lane_s8(vgetq_lane_s8(a, 13) / vgetq_lane_s8(b, 13),
                              c,
                              13);
            c = vsetq_lane_s8(vgetq_lane_s8(a, 14) / vgetq_lane_s8(b, 14),
                              c,
                              14);
            c = vsetq_lane_s8(vgetq_lane_s8(a, 15) / vgetq_lane_s8(b, 15),
                              c,
                              15);
            return c;
        }
        else
        {
            ...
            c = vsetq_lane_u8(vgetq_lane_u8(a, 10) / vgetq_lane_u8(b, 10),
                              c,
                              10);
            c = vsetq_lane_u8(vgetq_lane_u8(a, 11) / vgetq_lane_u8(b, 11),
                              c,
                              11);
            c = vsetq_lane_u8(vgetq_lane_u8(a, 12) / vgetq_lane_u8(b, 12),
                              c,
                              12);
            c = vsetq_lane_u8(vgetq_lane_u8(a, 13) / vgetq_lane_u8(b, 13),
                              c,
                              13);
            c = vsetq_lane_u8(vgetq_lane_u8(a, 14) / vgetq_lane_u8(b, 14),
                              c,
                              14);
            c = vsetq_lane_u8(vgetq_lane_u8(a, 15) / vgetq_lane_u8(b, 15),
                              c,
                              15);
            return c;
        }
    ...
    static vector_type pow(vector_type a, vector_type b)
    {
        if constexpr (std::is_signed_v<U>)
        {
            int8x16_t c;
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 0), vgetq_lane_s8(b, 0)),
                c,
                0);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 1), vgetq_lane_s8(b, 1)),
                c,
                1);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 2), vgetq_lane_s8(b, 2)),
                c,
                2);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 3), vgetq_lane_s8(b, 3)),
                c,
                3);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 4), vgetq_lane_s8(b, 4)),
                c,
                4);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 5), vgetq_lane_s8(b, 5)),
                c,
                5);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 6), vgetq_lane_s8(b, 6)),
                c,
                6);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 7), vgetq_lane_s8(b, 7)),
                c,
                7);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 8), vgetq_lane_s8(b, 8)),
                c,
                8);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 9), vgetq_lane_s8(b, 9)),
                c,
                9);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 10), vgetq_lane_s8(b, 10)),
                c,
                10);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 11), vgetq_lane_s8(b, 11)),
                c,
                11);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 12), vgetq_lane_s8(b, 12)),
                c,
                12);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 13), vgetq_lane_s8(b, 13)),
                c,
                13);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 14), vgetq_lane_s8(b, 14)),
                c,
                14);
            c = vsetq_lane_s8(
                (U)std::pow(vgetq_lane_s8(a, 15), vgetq_lane_s8(b, 15)),
                c,
                15);
            return c;
        }
        else
        {
            uint8x16_t c;
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 0), vgetq_lane_u8(b, 0)),
                c,
                0);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 1), vgetq_lane_u8(b, 1)),
                c,
                1);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 2), vgetq_lane_u8(b, 2)),
                c,
                2);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 3), vgetq_lane_u8(b, 3)),
                c,
                3);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 4), vgetq_lane_u8(b, 4)),
                c,
                4);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 5), vgetq_lane_u8(b, 5)),
                c,
                5);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 6), vgetq_lane_u8(b, 6)),
                c,
                6);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 7), vgetq_lane_u8(b, 7)),
                c,
                7);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 8), vgetq_lane_u8(b, 8)),
                c,
                8);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 9), vgetq_lane_u8(b, 9)),
                c,
                9);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 10), vgetq_lane_u8(b, 10)),
                c,
                10);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 11), vgetq_lane_u8(b, 11)),
                c,
                11);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 12), vgetq_lane_u8(b, 12)),
                c,
                12);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 13), vgetq_lane_u8(b, 13)),
                c,
                13);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 14), vgetq_lane_u8(b, 14)),
                c,
                14);
            c = vsetq_lane_u8(
                (U)std::pow(vgetq_lane_u8(a, 15), vgetq_lane_u8(b, 15)),
                c,
                15);
            return c;
        }
    ...
    static vector_type negate(vector_type a) { vnegq_s8(a); }
...
struct vector_traits<
    U,
    std::enable_if_t<std::is_same_v<U, int16_t> || std::is_same_v<U, uint16_t>>>
{
    static constexpr int vector_width = 8;
    static constexpr size_t alignment = 16;
    typedef std::conditional_t<std::is_signed_v<U>, int16x8_t, uint16x8_t>
        vector_type;
    ...
    static vector_type div(vector_type a, vector_type b)
    {
        ...
        {
            int16x8_t c;
            c = vsetq_lane_s16(vgetq_lane_s16(a, 0) / vgetq_lane_s16(b, 0),
                               c,
                               0);
            c = vsetq_lane_s16(vgetq_lane_s16(a, 1) / vgetq_lane_s16(b, 1),
                               c,
                               1);
            c = vsetq_lane_s16(vgetq_lane_s16(a, 2) / vgetq_lane_s16(b, 2),
                               c,
                               2);
            c = vsetq_lane_s16(vgetq_lane_s16(a, 3) / vgetq_lane_s16(b, 3),
                               c,
                               3);
            c = vsetq_lane_s16(vgetq_lane_s16(a, 4) / vgetq_lane_s16(b, 4),
                               c,
                               4);
            c = vsetq_lane_s16(vgetq_lane_s16(a, 5) / vgetq_lane_s16(b, 5),
                               c,
                               5);
            c = vsetq_lane_s16(vgetq_lane_s16(a, 6) / vgetq_lane_s16(b, 6),
                               c,
                               6);
            c = vsetq_lane_s16(vgetq_lane_s16(a, 7) / vgetq_lane_s16(b, 7),
                               c,
                               7);
            return c;
        }
        ...
        {
            uint16x8_t c;
            c = vsetq_lane_u16(vgetq_lane_u16(a, 0) / vgetq_lane_u16(b, 0),
                               c,
                               0);
            c = vsetq_lane_u16(vgetq_lane_u16(a, 1) / vgetq_lane_u16(b, 1),
                               c,
                               1);
            c = vsetq_lane_u16(vgetq_lane_u16(a, 2) / vgetq_lane_u16(b, 2),
                               c,
                               2);
            c = vsetq_lane_u16(vgetq_lane_u16(a, 3) / vgetq_lane_u16(b, 3),
                               c,
                               3);
            c = vsetq_lane_u16(vgetq_lane_u16(a, 4) / vgetq_lane_u16(b, 4),
                               c,
                               4);
            c = vsetq_lane_u16(vgetq_lane_u16(a, 5) / vgetq_lane_u16(b, 5),
                               c,
                               5);
            c = vsetq_lane_u16(vgetq_lane_u16(a, 6) / vgetq_lane_u16(b, 6),
                               c,
                               6);
            c = vsetq_lane_u16(vgetq_lane_u16(a, 7) / vgetq_lane_u16(b, 7),
                               c,
                               7);
            return c;
        }
    ...
    static vector_type pow(vector_type a, vector_type b)
    {
        if constexpr (std::is_signed_v<U>)
        {
            int16x8_t c;
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 0), vgetq_lane_s16(b, 0)),
                c,
                0);
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 1), vgetq_lane_s16(b, 1)),
                c,
                1);
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 2), vgetq_lane_s16(b, 2)),
                c,
                2);
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 3), vgetq_lane_s16(b, 3)),
                c,
                3);
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 4), vgetq_lane_s16(b, 4)),
                c,
                4);
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 5), vgetq_lane_s16(b, 5)),
                c,
                5);
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 6), vgetq_lane_s16(b, 6)),
                c,
                6);
            c = vsetq_lane_s16(
                (U)std::pow(vgetq_lane_s16(a, 7), vgetq_lane_s16(b, 7)),
                c,
                7);
            return c;
        }
        else
        {
            uint16x8_t c;
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 0), vgetq_lane_u16(b, 0)),
                c,
                0);
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 1), vgetq_lane_u16(b, 1)),
                c,
                1);
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 2), vgetq_lane_u16(b, 2)),
                c,
                2);
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 3), vgetq_lane_u16(b, 3)),
                c,
                3);
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 4), vgetq_lane_u16(b, 4)),
                c,
                4);
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 5), vgetq_lane_u16(b, 5)),
                c,
                5);
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 6), vgetq_lane_u16(b, 6)),
                c,
                6);
            c = vsetq_lane_u16(
                (U)std::pow(vgetq_lane_u16(a, 7), vgetq_lane_u16(b, 7)),
                c,
                7);
            return c;
        }
...
struct vector_traits<
    U,
    std::enable_if_t<std::is_same_v<U, int32_t> || std::is_same_v<U, uint32_t>>>
{
    static constexpr int vector_width = 4;
    static constexpr size_t alignment = 16;
    typedef std::conditional_t<std::is_signed_v<U>, int32x4_t, uint32x4_t>
        vector_type;
    ...
    static vector_type div(vector_type a, vector_type b)
    {
        ...
        {
            int32x4_t c;
            c = vsetq_lane_s32(vgetq_lane_s32(a, 0) / vgetq_lane_s32(b, 0),
                               c,
                               0);
            c = vsetq_lane_s32(vgetq_lane_s32(a, 1) / vgetq_lane_s32(b, 1),
                               c,
                               1);
            c = vsetq_lane_s32(vgetq_lane_s32(a, 2) / vgetq_lane_s32(b, 2),
                               c,
                               2);
            c = vsetq_lane_s32(vgetq_lane_s32(a, 3) / vgetq_lane_s32(b, 3),
                               c,
                               3);
            return c;
        }
        ...
        {
            uint32x4_t c;
            c = vsetq_lane_u32(vgetq_lane_u32(a, 0) / vgetq_lane_u32(b, 0),
                               c,
                               0);
            c = vsetq_lane_u32(vgetq_lane_u32(a, 1) / vgetq_lane_u32(b, 1),
                               c,
                               1);
            c = vsetq_lane_u32(vgetq_lane_u32(a, 2) / vgetq_lane_u32(b, 2),
                               c,
                               2);
            c = vsetq_lane_u32(vgetq_lane_u32(a, 3) / vgetq_lane_u32(b, 3),
                               c,
                               3);
            return c;
        }
    ...
    static vector_type pow(vector_type a, vector_type b)
    {
        if constexpr (std::is_signed_v<U>)
        {
            int32x4_t c;
            c = vsetq_lane_s32(
                (U)std::pow(vgetq_lane_s32(a, 0), vgetq_lane_s32(b, 0)),
                c,
                0);
            c = vsetq_lane_s32(
                (U)std::pow(vgetq_lane_s32(a, 1), vgetq_lane_s32(b, 1)),
                c,
                1);
            c = vsetq_lane_s32(
                (U)std::pow(vgetq_lane_s32(a, 2), vgetq_lane_s32(b, 2)),
                c,
                2);
            c = vsetq_lane_s32(
                (U)std::pow(vgetq_lane_s32(a, 3), vgetq_lane_s32(b, 3)),
                c,
                3);
            return c;
        }
        else
        {
            uint32x4_t c;
            c = vsetq_lane_u32(
                (U)std::pow(vgetq_lane_u32(a, 0), vgetq_lane_u32(b, 0)),
                c,
                0);
            c = vsetq_lane_u32(
                (U)std::pow(vgetq_lane_u32(a, 1), vgetq_lane_u32(b, 1)),
                c,
                1);
            c = vsetq_lane_u32(
                (U)std::pow(vgetq_lane_u32(a, 2), vgetq_lane_u32(b, 2)),
                c,
                2);
            c = vsetq_lane_u32(
                (U)std::pow(vgetq_lane_u32(a, 3), vgetq_lane_u32(b, 3)),
                c,
                3);
            return c;
        }
...
struct vector_traits<
    U,
    std::enable_if_t<std::is_same_v<U, int64_t> || std::is_same_v<U, uint64_t>>>
{
    static constexpr int vector_width = 2;
    static constexpr size_t alignment = 16;
    typedef std::conditional_t<std::is_signed_v<U>, int64x2_t, uint64x2_t>
        vector_type;
    ...
    static vector_type mul(vector_type a, vector_type b)
    {
        ...
        {
            int64x2_t c;
            c = vsetq_lane_s64(vgetq_lane_s64(a, 0) * vgetq_lane_s64(b, 0),
                               c,
                               0);
            c = vsetq_lane_s64(vgetq_lane_s64(a, 1) * vgetq_lane_s64(b, 1),
                               c,
                               1);
            return c;
        }
        ...
        {
            uint64x2_t c;
            c = vsetq_lane_u64(vgetq_lane_u64(a, 0) * vgetq_lane_u64(b, 0),
                               c,
                               0);
            c = vsetq_lane_u64(vgetq_lane_u64(a, 1) * vgetq_lane_u64(b, 1),
                               c,
                               1);
            return c;
        }
    ...
    static vector_type pow(vector_type a, vector_type b)
    {
        if constexpr (std::is_signed_v<U>)
        {
            int64x2_t c;
            c = vsetq_lane_s64(
                (U)std::pow(vgetq_lane_s64(a, 0), vgetq_lane_s64(b, 0)),
                c,
                0);
            c = vsetq_lane_s64(
                (U)std::pow(vgetq_lane_s64(a, 1), vgetq_lane_s64(b, 1)),
                c,
                1);
            return c;
        }
        else
        {
            uint64x2_t c;
            c = vsetq_lane_u64(
                (U)std::pow(vgetq_lane_u64(a, 0), vgetq_lane_u64(b, 0)),
                c,
                0);
            c = vsetq_lane_u64(
                (U)std::pow(vgetq_lane_u64(a, 1), vgetq_lane_u64(b, 1)),
                c,
                1);
            return c;
        }
