...
: public indexed_marray_base<Type, indexed_marray<Type, Allocator>, true>
{
  ...
  public:
    ...
    indexed_marray(const indexed_marray& other) { reset(other); }

    indexed_marray(indexed_marray&& other) { reset(std::move(other)); }
    ...
    void reset(indexed_marray&& other) { swap(other); }
    ...
    friend void swap(indexed_marray& a, indexed_marray& b) { a.swap(b); }
};
