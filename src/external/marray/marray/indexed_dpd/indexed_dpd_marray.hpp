...
: public indexed_dpd_marray_base<Type,
                                 indexed_dpd_marray<Type, Allocator>,
                                 true>
{
  ...
  public:
    ...
    indexed_dpd_marray() { reset(); }

    indexed_dpd_marray(const indexed_dpd_marray& other) { reset(other); }

    indexed_dpd_marray(indexed_dpd_marray&& other) { reset(std::move(other)); }
    ...
    stride_type size() const { return dense_size() * num_indices(); }
    ...
    void reset(indexed_dpd_marray&& other) { swap(other); }
               ...
               dpd_layout layout = DEFAULT_LAYOUT)
    {
        ...
        reset(irrep,
              ...
              idx,
              uninitialized,
              this->default_depth(layout, dense_ndim),
              layout.base());
    }
