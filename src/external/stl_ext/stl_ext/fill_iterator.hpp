...
template <typename T> class fill_iterator
{
  public:
    ...
    fill_iterator(size_t, reference ref) : ptr_(&ref) {}
    ...
    reference operator[](difference_type) { return *ptr_; }
    ...
    bool operator<(const fill_iterator<U>& other) const
    {
        return ptr_ < other.ptr_ || (ptr_ == other.ptr_ && idx_ < other.idx_);
    }
...
template <typename T> using const_fill_iterator = fill_iterator<const T>;

template <typename T> fill_iterator<T> fill_begin(size_t n, T& value)
{
    return fill_iterator<T>(n, value);
}

template <typename T> fill_iterator<T> fill_end(size_t n, T& value)
{
...
template <typename T> const_fill_iterator<T> fill_end(size_t n, const T& value)
{
    return const_fill_iterator<T>(n, value) + n;
}

template <typename T> const_fill_iterator<T> fill_cbegin(size_t n, T& value)
{
    return const_fill_iterator<T>(n, value);
}

template <typename T> const_fill_iterator<T> fill_cend(size_t n, T& value)
{
    return const_fill_iterator<T>(n, value) + n;
}
