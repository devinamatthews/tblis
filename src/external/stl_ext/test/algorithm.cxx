...
{
    binary_or<logical_not<bool>, logical_not<bool>> bor1{logical_not<bool>(),
                                                         logical_not<bool>()};
    EXPECT_EQ(false, bor1(true));

    binary_or<logical_not<bool>, unary_negate<logical_not<bool>>> bor2{
        logical_not<bool>(),
        unary_negate<logical_not<bool>>(logical_not<bool>())};
    EXPECT_EQ(true, bor2(true));

    binary_or<unary_negate<logical_not<bool>>, logical_not<bool>> bor3{
        unary_negate<logical_not<bool>>(logical_not<bool>()),
        logical_not<bool>()};
    EXPECT_EQ(true, bor3(true));

    binary_or<unary_negate<logical_not<bool>>, unary_negate<logical_not<bool>>>
        bor4{unary_negate<logical_not<bool>>(logical_not<bool>()),
             unary_negate<logical_not<bool>>(logical_not<bool>())};
...
{
    binary_and<logical_not<bool>, logical_not<bool>> band1{logical_not<bool>(),
                                                           logical_not<bool>()};
    EXPECT_EQ(false, band1(true));

    binary_and<logical_not<bool>, unary_negate<logical_not<bool>>> band2{
        logical_not<bool>(),
        unary_negate<logical_not<bool>>(logical_not<bool>())};
    EXPECT_EQ(false, band2(true));

    binary_and<unary_negate<logical_not<bool>>, logical_not<bool>> band3{
        unary_negate<logical_not<bool>>(logical_not<bool>()),
        logical_not<bool>()};
    EXPECT_EQ(false, band3(true));

    binary_and<unary_negate<logical_not<bool>>, unary_negate<logical_not<bool>>>
        band4{unary_negate<logical_not<bool>>(logical_not<bool>()),
              unary_negate<logical_not<bool>>(logical_not<bool>())};
...
TEST(unit_algorithm, or1)
{
    ...
    EXPECT_EQ(true,
              or1(not1(logical_not<bool>()), not1(logical_not<bool>()))(true));
}
...
TEST(unit_algorithm, and1)
{
    ...
    EXPECT_EQ(false,
              and1(logical_not<bool>(), not1(logical_not<bool>()))(true));
    EXPECT_EQ(false,
              and1(not1(logical_not<bool>()), logical_not<bool>())(true));
    EXPECT_EQ(true,
              and1(not1(logical_not<bool>()), not1(logical_not<bool>()))(true));
}
