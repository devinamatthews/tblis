...
TEST(unit_complex, traits)
{
    ...
    EXPECT_TRUE(
        (is_same<complex_type_t<complex<double>>, complex<double>>::value));
    EXPECT_TRUE(is_complex_v<complex<double>>);
    EXPECT_FALSE(is_complex_v<double>);
}

#define COMPLEX_OP_REAL_2(op,                                             \
                          type1,                                          \
                          type2,                                          \
                          real_in,                                        \
                          imag_in,                                        \
