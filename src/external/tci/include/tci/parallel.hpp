...
{
  public:
    prime_factorization(unsigned n) { tci_prime_factorization(n, &_factors); }

    unsigned next() { return tci_next_prime_factor(&_factors); }
...
inline std::pair<unsigned, unsigned> partition_2x2(unsigned nthreads,
                                                   uint64_t work1,
                                                   unsigned max1,
                                                   uint64_t work2,
                                                   unsigned max2)
