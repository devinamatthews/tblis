                ...
                [&](stride_type next_A)
                {
                    ...
                    tasks.visit(
                        ...
                        [&, idx_A, idx_B, next_A](const communicator& subcomm)
                        {
                            ...
                            auto data_B = B.data(0)
                                        + (indices_B[idx_B].offset + off_B_AB)
                                        * ts;

                            for (auto local_idx_A = idx_A; local_idx_A < next_A;
                                 local_idx_A++)
                            {
                                auto factor = alpha
                     ...
                     const dim_vector& idx_B_AB)
{
    ...
    stride_vector dense_stride_B =
        group_AB.dense_stride[1] + group_B.dense_stride[0];
                         ...
                         local_idx_B++)
                    {
                        ...
                        tasks.visit(
                                ...
                                const communicator& subcomm)
                            {
                                ...
                                auto data_A =
                                    A.data(0)
                                    + (indices_A[idx_A].offset + off_A_AB)
                                    * ts;
                                auto data_B =
                                    B.data(0)
