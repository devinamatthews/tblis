#include "indexed_dpd_reduce.hpp"
...
template <typename T>
void indexed_dpd_reduce(const communicator& comm, const config& cfg, reduce_t op,
                        ...
                        T& result, len_type& idx)
{
    ...
    {
        dpd_reduce<T>(comm, cfg, op, local_A, idx_A_A, block_result, block_idx);
...
template void indexed_dpd_reduce(const communicator& comm, const config& cfg, reduce_t op, \
