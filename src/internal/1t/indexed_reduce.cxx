...
template <typename T>
void indexed_reduce(const communicator& comm, const config& cfg, reduce_t op,
                    ...
                    T& result, len_type& idx)
{
    ...
    A.for_each_index(
    [&](const varray_view<const T>& local_A)
    {
...
template void indexed_reduce(const communicator& comm, const config& cfg, reduce_t op, \
