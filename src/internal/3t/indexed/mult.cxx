...
void contract_block(type_t type,
                                ...
                                [&](stride_type next_B_AB)
                                {
                                    ...
                                    tasks.visit(
                                        ...
                                        [&,
                                         ...
                                         idx_C,
                                         next_A_AB,
                                         next_B_AB](const communicator& subcomm)
                                        {
                                            auto local_idx_A = idx_A;
                                            auto local_idx_B = idx_B;

                                            stride_type off_A_ABC, off_B_ABC,
                                                off_C_ABC;
                                            get_local_offset(
                                                indices_A[local_idx_A].idx[0],
                                                group_ABC,
        ...
        switch (type)
        {
            case TYPE_FLOAT:
                mult_full(
                    ...
                    alpha.get<float>(),
                    conj_A,
                    reinterpret_cast<const indexed_marray_view<float>&>(A),
                    idx_A_AB,
                    idx_A_AC,
                    idx_A_ABC,
                    conj_B,
                    reinterpret_cast<const indexed_marray_view<float>&>(B),
                    idx_B_AB,
                    idx_B_BC,
                    idx_B_ABC,
                    reinterpret_cast<const indexed_marray_view<float>&>(C),
                    idx_C_AC,
                    idx_C_BC,
                    idx_C_ABC);
                break;
            case TYPE_DOUBLE:
                mult_full(
                    ...
                    alpha.get<double>(),
                    conj_A,
                    reinterpret_cast<const indexed_marray_view<double>&>(A),
                    idx_A_AB,
                    idx_A_AC,
                    idx_A_ABC,
                    conj_B,
                    reinterpret_cast<const indexed_marray_view<double>&>(B),
                    idx_B_AB,
                    idx_B_BC,
                    idx_B_ABC,
                    reinterpret_cast<const indexed_marray_view<double>&>(C),
                    idx_C_AC,
                    idx_C_BC,
                    idx_C_ABC);
                break;
            case TYPE_SCOMPLEX:
                mult_full(
                    ...
                    alpha.get<scomplex>(),
                    conj_A,
                    reinterpret_cast<const indexed_marray_view<scomplex>&>(A),
                    idx_A_AB,
                    idx_A_AC,
                    idx_A_ABC,
                    conj_B,
                    reinterpret_cast<const indexed_marray_view<scomplex>&>(B),
                    idx_B_AB,
                    idx_B_BC,
                    idx_B_ABC,
                    reinterpret_cast<const indexed_marray_view<scomplex>&>(C),
                    idx_C_AC,
                    idx_C_BC,
                    idx_C_ABC);
                break;
            case TYPE_DCOMPLEX:
                mult_full(
                    ...
                    alpha.get<dcomplex>(),
                    conj_A,
                    reinterpret_cast<const indexed_marray_view<dcomplex>&>(A),
                    idx_A_AB,
                    idx_A_AC,
                    idx_A_ABC,
                    conj_B,
                    reinterpret_cast<const indexed_marray_view<dcomplex>&>(B),
                    idx_B_AB,
                    idx_B_BC,
                    idx_B_ABC,
                    reinterpret_cast<const indexed_marray_view<dcomplex>&>(C),
                    idx_C_AC,
                    idx_C_BC,
                    idx_C_ABC);
                break;
