                    ...
                    for (len_type m = 0;m < batch_M;m++)
                    {
                        ...
                        for (len_type n = 0;n < batch_N;n++)
                        {
                            if (batch_A[m][k] && batch_B[k][n] && batch_C[m][n])
                            {
                                ...
                                internal::mult(subcomm, get_default_config(),
                                    {}, {}, {}, dense_len_AB, dense_len_AC, dense_len_BC, {},
                                               alpha, batch_A[m][k], {}, dense_stride_A_AB, dense_stride_A_AC, {},
                                                      batch_B[k][n], {}, dense_stride_B_AB, dense_stride_B_BC, {},
                                    batch_beta[m][n], batch_C[m][n], {}, dense_stride_C_AC, dense_stride_C_BC, {});
                     ...
                     T  beta,       indexed_varray_view<T> C, const label_type* idx_C_)
{
    ...
    std::vector<tci::slot<>> slot(batch_M*batch_N);
