...
void dot(const communicator& comm,
         ...
         MArray::dpd_varray_view<const T> B, const label_string& idx_B, T& result);

template <typename T>
void dot(MArray::dpd_varray_view<const T> A, const label_string& idx_A,
         MArray::dpd_varray_view<const T> B, const label_string& idx_B, T& result)
{
    parallelize
    (
...
template <typename T>
T dot(MArray::dpd_varray_view<const T> A, const label_string& idx_A,
      MArray::dpd_varray_view<const T> B, const label_string& idx_B)
{
    T result;
    dot(A, idx_A, B, idx_B, result);
    return result;
...
void dot(const communicator& comm,
         ...
         MArray::indexed_varray_view<const T> B, const label_string& idx_B, T& result);

template <typename T>
void dot(MArray::indexed_varray_view<const T> A, const label_string& idx_A,
         MArray::indexed_varray_view<const T> B, const label_string& idx_B, T& result)
{
    parallelize
    (
...
template <typename T>
T dot(MArray::indexed_varray_view<const T> A, const label_string& idx_A,
      MArray::indexed_varray_view<const T> B, const label_string& idx_B)
{
    T result;
    dot(A, idx_A, B, idx_B, result);
    return result;
...
void dot(const communicator& comm,
         ...
         MArray::indexed_dpd_varray_view<const T> B, const label_string& idx_B, T& result);

template <typename T>
void dot(MArray::indexed_dpd_varray_view<const T> A, const label_string& idx_A,
         MArray::indexed_dpd_varray_view<const T> B, const label_string& idx_B, T& result)
{
    parallelize
    (
...
template <typename T>
T dot(MArray::indexed_dpd_varray_view<const T> A, const label_string& idx_A,
      MArray::indexed_dpd_varray_view<const T> B, const label_string& idx_B)
{
    T result;
    dot(A, idx_A, B, idx_B, result);
    return result;
