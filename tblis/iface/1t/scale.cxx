...
void scale(const communicator& comm,
           T alpha, dpd_varray_view<T> A, const label_string& idx_A)
{
    (void)idx_A;
...
template <typename T>
void scale(const communicator& comm,
           T alpha, indexed_varray_view<T> A, const label_string& idx_A)
{
    (void)idx_A;
...
template <typename T>
void scale(const communicator& comm,
           T alpha, indexed_dpd_varray_view<T> A, const label_string& idx_A)
{
    (void)idx_A;
