...
template <typename T>
void scale(T alpha, MArray::dpd_varray_view<T> A, const label_string& idx_A)
{
    parallelize
    (
...
template <typename T>
void scale(T alpha, MArray::indexed_varray_view<T> A, const label_string& idx_A)
{
    parallelize
    (
        [&](const communicator& comm)
...
template <typename T>
void scale(T alpha, MArray::indexed_dpd_varray_view<T> A, const label_string& idx_A)
{
    parallelize
    (
        [&](const communicator& comm)
