...
void shift(const communicator& comm,
           T alpha, T beta, dpd_varray_view<T> A, const label_string& idx_A)
{
    (void)idx_A;
...
template <typename T>
void shift(const communicator& comm,
           T alpha, T beta, indexed_varray_view<T> A, const label_string& idx_A)
{
    (void)idx_A;
...
template <typename T>
void shift(const communicator& comm,
           T alpha, T beta, indexed_dpd_varray_view<T> A, const label_string& idx_A)
{
    (void)idx_A;
