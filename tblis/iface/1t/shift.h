...
template <typename T>
void shift(const communicator& comm,
         T alpha, T beta, MArray::dpd_varray_view<T> A, const label_string& idx_A);

template <typename T>
void shift(T alpha, T beta, MArray::dpd_varray_view<T> A, const label_string& idx_A)
{
    parallelize
    (
...
template <typename T>
void shift(const communicator& comm,
         T alpha, T beta, MArray::indexed_varray_view<T> A, const label_string& idx_A);

template <typename T>
void shift(T alpha, T beta, MArray::indexed_varray_view<T> A, const label_string& idx_A)
{
    parallelize
    (
        [&](const communicator& comm)
...
template <typename T>
void shift(const communicator& comm,
         T alpha, T beta, MArray::indexed_dpd_varray_view<T> A, const label_string& idx_A);

template <typename T>
void shift(T alpha, T beta, MArray::indexed_dpd_varray_view<T> A, const label_string& idx_A)
{
    parallelize
    (
        [&](const communicator& comm)
